 ...
 */
class Formulariostipo extends \Fix\ServicemeBundle\Entity\Formulariostipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariostipo' . "\0" . 'id', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariostipo' . "\0" . 'nombre', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariostipo' . "\0" . 'estado', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariostipo' . "\0" . 'servicio', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariostipo' . "\0" . 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Formulariostipo $proxy) {
