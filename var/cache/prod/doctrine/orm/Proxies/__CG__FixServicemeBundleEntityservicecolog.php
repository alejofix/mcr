 ...
 */
class servicecolog extends \Fix\ServicemeBundle\Entity\servicecolog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'id', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'fecha', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'evento', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'descripcion', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'usuario', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\servicecolog' . "\0" . 'altoimpacto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (servicecolog $proxy) {
    ...
    public function setAltoimpacto(\Fix\ServicemeBundle\Entity\Serviceco $altoimpacto = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAltoimpacto', [$altoimpacto]);

        return parent::setAltoimpacto($altoimpacto);
    }
    ...
    public function getAltoimpacto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAltoimpacto', []);

        return parent::getAltoimpacto();
    }
