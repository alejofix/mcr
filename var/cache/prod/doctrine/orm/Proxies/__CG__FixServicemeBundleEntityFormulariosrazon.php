 ...
 */
class Formulariosrazon extends \Fix\ServicemeBundle\Entity\Formulariosrazon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariosrazon' . "\0" . 'id', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariosrazon' . "\0" . 'nombre', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariosrazon' . "\0" . 'estado', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Formulariosrazon' . "\0" . 'tipo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Formulariosrazon $proxy) {
