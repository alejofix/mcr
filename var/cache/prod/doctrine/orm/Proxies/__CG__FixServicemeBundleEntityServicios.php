 ...
 */
class Servicios extends \Fix\ServicemeBundle\Entity\Servicios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Servicios' . "\0" . 'id', '' . "\0" . 'Fix\\ServicemeBundle\\Entity\\Servicios' . "\0" . 'producto'];
        }
